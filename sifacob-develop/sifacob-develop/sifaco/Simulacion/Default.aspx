                                    ...
                                    <asp:Repeater runat="server" ID="rptSimulaciones" OnItemCommand="rptSimulaciones_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnEdit" runat="server" CommandName="edit" CssClass="btn btn-info disabled-guest" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID")+";"+DataBinder.Eval(Container.DataItem, "IdCliente") %>'
