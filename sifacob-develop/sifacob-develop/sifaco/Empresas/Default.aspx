        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li  runat="server" id="tab2"><a href="#activity" data-toggle="tab">Cliente Empresa</a></li>
            </ul>
                            ...
                            <asp:Repeater runat="server" ID="rptGrid" onitemcommand="rptGrid_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><asp:LinkButton ID="lbSim" runat="server" ClientIDMode="Static" CommandName="sim"  CssClass="btn btn-app"
                                        ...
                                        <td><asp:LinkButton ID="lbAgregar" runat="server" CommandName="add"  CssClass="btn btn-app"
