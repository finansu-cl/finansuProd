<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rechazadas.aspx.cs" Inherits="sifaco.Autorizacion.Rechazadas" EnableViewStateMac="false"%>
...
<%--      <h1>
        Autorizacion
        <small>Operaciones Rechazadas</small>
      </h1>--%>
</section>
</asp:Content>
...
<div class="row">
    <div class="box box-primary">
                <div class="box-header with-border">
                        <h3 class="box-title">Operaciones rechazadas</h3>
                    </div>
                    <br />
