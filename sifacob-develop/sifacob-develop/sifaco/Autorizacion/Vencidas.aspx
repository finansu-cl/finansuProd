<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vencidas.aspx.cs" Inherits="sifaco.Autorizacion.Vencidas" EnableViewStateMac="false"%>
...
<section class="content-header">
     <%-- <h1>
        Autorizacion
        <small>Operaciones Vencidas</small>
      </h1>--%>
</section>
</asp:Content>
...
<div class="row">
    <div class="box box-primary">
        <div class="box-header with-border">
                <h3 class="box-title">Operaciones autorizadas automaticamente</h3>
            </div>
            <br />
