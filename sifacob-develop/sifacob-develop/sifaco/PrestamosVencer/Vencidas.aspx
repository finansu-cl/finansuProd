<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vencidas.aspx.cs" Inherits="sifaco.PrestamosVencer.Vencidas" %>
    ...
    <div class="panel box box-primary">
        <div class="box-body">
            <div class="box-header with-border">
                        <h3 class="box-title">Cuotas vencidas</h3>
                    </div>
                    <br />
                ...
                <table id="example3" class="table table-striped table-bordered nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th align="center">Días de atraso</th>
                    ...
                    <tbody>
                        <asp:Repeater runat="server" ID="rptClienteFactura">
                            <ItemTemplate>
                                <tr <%# (Eval("IdEdoPres").ToString()=="11")?"style='background:#caef00;color:black;'" : (Convert.ToInt32(Eval("VenceEn"))>0)?"style='background:red;color:white;'": ""%>>
                                      ...
                                      <td><%# (Eval("IdEdoPres").ToString()=="11")? "PAGO PARCIAL MORA" : "VENCIDA" %></td>
