            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li runat="server" id="tab2" class="disabled-guest"><a href="#activity" data-toggle="tab">Cliente Persona</a></li>
                    </ul>
                                    ...
                                    <asp:Repeater runat="server" ID="rptGrid" OnItemCommand="rptGrid_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lbSim" runat="server" CommandName="sim" CssClass="btn btn-app disabled-guest"
