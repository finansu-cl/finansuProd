<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="sifaco.Prestamos.Default" EnableViewStateMac="false"%>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnEdit" runat="server" CommandName="edit"  CssClass="btn btn-info" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID")+";"+DataBinder.Eval(Container.DataItem, "IdCliente") %>' 
                                                    Text='<%# (Session["rol"] != null && Session["rol"].ToString() == "admin") ? "Editar" : "Ver"%>' />
