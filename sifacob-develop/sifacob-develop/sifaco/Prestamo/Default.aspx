                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" style="width: 60%">
                                            <h3 class="box-title">
                                                <asp:Literal runat="server" ID="ltrCliente"></asp:Literal></h3>
                                        </td>
                                        <td align="center" style="width: 40%">
                                            <h3 class="box-title">
                                                <asp:Literal runat="server" ID="ltrRutCliente"></asp:Literal></h3>
                                        </td>
                                    </tr>
                                    ...
                                    <ItemTemplate>
                                        <tr <%# (Eval("IdEdoPres").ToString()=="2")?"style='background:red;color:white;'":(Eval("IdEdoPres").ToString()=="3")?"style='background:green;color:white;'":(Eval("IdEdoPres").ToString()=="4")?"style='background:orange;color:black;'":(Eval("IdEdoPres").ToString()=="5")?"style='background:violet;color:white;'":(Eval("IdEdoPres").ToString()=="6")?"style='background:blue;color:white;'":(Eval("IdEdoPres").ToString()=="7")?"style='background:gray;color:black;'":(Eval("IdEdoPres").ToString()=="8")?"style='background:#caef00;color:black;'" : (Eval("IdEdoPres").ToString()=="9")?"style='background:#9cb9f9;color:black;'":(Eval("IdEdoPres").ToString()=="11")?"style='background:navajowhite;color:black;'":(Eval("IdEdoPres").ToString()=="12")?"style='background:coral;color:black;'":"style='background:white;color:black;'"%>>
                                            ...
                                            <td style='color: black;'>
                                                <select id='ddl<%# DataBinder.Eval(Container.DataItem, "ID") %>' style='width: 163px;' class="disabled-guest">
                                 ...
                                 "<option value='11' selected='selected' style='background:#caef00;color:black;'>PAGO PARCIAL MORA</option>" : "<option value='11' style='background:#caef00;color:black;'>PAGO PARCIAL MORA</option>" : "" %>
                                        ...
                                        $('#btnGuar12<%# DataBinder.Eval(Container.DataItem, "ID") %>').show();
                                            ...
                                            <td>
                                                ...
                                                <input class="disabled-guest" type='text' id='datePickV<%# DataBinder.Eval(Container.DataItem, "ID") %>' style='display: none; color: black;' />
                                                <input class="disabled-guest" type='button' id='btnGuarV<%# DataBinder.Eval(Container.DataItem, "ID") %>' value='Guardar Vencimiento' style='display: none; color: black;' />
                                            </td>
                                            <td>
                                                <%#  (Eval("IdEdoPres").ToString()!="8")? "$" + decimal.Parse(Eval("Mora").ToString()).ToString("N"): "$" + decimal.Parse(Eval("MontoRestanteMora").ToString()).ToString("N")%>
                                            ...
                                            <td>
                                                ...
                                                <input class="disabled-guest" type='text' id='datePick12<%# DataBinder.Eval(Container.DataItem, "ID") %>' style='display: none; color: black;' />
                                                <input class="disabled-guest" type='button' id='btnGuar12<%# DataBinder.Eval(Container.DataItem, "ID") %>' value='Guardar' style='display: none; color: black;' />

                                            </td>
                                            <td style="color: Black;">
                                                <textarea class="disabled-guest" id='txtObser<%# DataBinder.Eval(Container.DataItem, "ID") %>' rows="5" cols="20"><%# (Eval("Observacion") == null)?"":Eval("Observacion").ToString().Trim()%></textarea>
                                                <input class="disabled-guest" type='button' id='btnSaveObser<%# DataBinder.Eval(Container.DataItem, "ID") %>' value='Guardar' />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
