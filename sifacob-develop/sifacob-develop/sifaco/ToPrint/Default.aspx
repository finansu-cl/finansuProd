<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="sifaco.ToPrint.Default" EnableViewStateMac="false" %>
...
<head id="Head1" runat="server">
    ...
    <title></title>
    <link href="../Styles/AdminLTE.min.css" rel="stylesheet" type="text/css" media="print"/>
    <link href="../Styles/bootstrap.min.css" rel="stylesheet" type="text/css" media="print"/>
    <link href="../Styles/AdminLTE.min.css" rel="stylesheet" type="text/css" media="screen"/>
                            ...
                            <table id="example3" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center" style="width:40%"><h3 class="box-title"><asp:Literal runat="server" ID="ltrCliente"></asp:Literal></h3></td>
                                        <td align="center" style="width:30%"><h3 class="box-title"><asp:Literal runat="server" ID="ltrRutCliente"></asp:Literal></h3></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
